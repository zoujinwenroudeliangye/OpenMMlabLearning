...
log_level = 'INFO'
load_from = 'work_dirs/rtmdet_tiny_1xb12-40e_balloon/best_coco_bbox_mAP_epoch_40.pth'
resume = False
train_cfg = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='data/balloon/',
        ann_file='train/custom_train.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='data/balloon/val/custom_val.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
